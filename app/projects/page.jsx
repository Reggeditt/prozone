        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-orange-100 mb-8">
              Explore our successful construction projects across Ghana,
              showcasing our expertise in delivering exceptional results.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Highlighting some of our most successful and innovative
              construction projects that demonstrate our commitment to
              excellence.
            </p>
          </div>
                ...
                >
                  ...
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-600 text-sm mb-4">
                      A showcase of our expertise in{" "}
                      {project.category.toLowerCase()}, delivering exceptional
                      results that exceed client expectations and industry
                      standards.
                    </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We specialize in various types of construction projects, each
              requiring unique expertise and attention to detail.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Office buildings, retail spaces, and commercial complexes for
                  businesses.
                </p>
            ...
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  CCTV installation, gate automation, and comprehensive security
                  solutions.
                </p>
            ...
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Complete electrical installations, wiring, and power system
                  solutions.
                </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Challenge:{" "}
                {constructionContent.projects.caseStudies[0].challenge}
              </p>
              <p className="text-gray-600 mb-8">
                We successfully integrated eco-friendly materials and
                sustainable construction practices in a large residential
                complex, reducing environmental impact by 40% while maintaining
      ...
      <section className="py-20 bg-orange-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
            ...
            discuss your construction needs and get a detailed project proposal.
          </p>
